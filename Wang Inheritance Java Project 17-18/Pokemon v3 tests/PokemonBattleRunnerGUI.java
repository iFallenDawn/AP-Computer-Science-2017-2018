...
public class PokemonBattleRunnerGUI extends JFrame
{
	...
	private class ButtonListener implements ActionListener
	{
		public void actionPerformed(ActionEvent event)
		{
			...
			{
				String strName = JOptionPane.showInputDialog("Name your Pokemon: ");
				if(strName.equalsIgnoreCase(""))
					user = new Starter("Scratch", 20, "Torchic", 5, "Fire", 2);
				else
					user = new Starter("Scratch", 20, strName, 5, "Fire", 2);
			...
			if(source == btnTreecko)
			{
				...
				if(strName.equalsIgnoreCase(""))
					...
					user = new Starter("Pound", 20, strName, 5, "Grass", 2);
			...
			if(source == btnMudkip)
			{
				...
				if(strName.equalsIgnoreCase(""))
					...
					user = new Starter("Mudkip", 20, strName, 5, "Water", 2);
